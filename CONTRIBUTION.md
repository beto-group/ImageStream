...
3. Make changes in `src/components/StreamComponent.jsx` or `src/App.jsx`.
...
1. Ensure the code is properly formatted and adheres to BetoOS styling (no emojis in UI, use Obsidian CSS variables, standard function signatures).
