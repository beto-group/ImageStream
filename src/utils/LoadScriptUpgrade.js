...
async function loadScript(dc, src, options = {}) {
  ...
  // Resolve custom cacheDir or default to IMAGE STREAM local path
  const resolvedCacheDir = cacheDir ? dc.resolvePath(cacheDir) : dc.resolvePath("IMAGE STREAM/data/cache/scripts");
